    ...
    <center>
        <table style="width: 505px; height: 305px;">
           ...
           <tr>
            ...
            <tr>
               <td style="width: 128px"><asp:TextBox ID="txt3" placeholder="Enter Subject" runat="server" BackColor="#FF9999"></asp:TextBox></td>
           </tr>
           
            <tr>
               <td style="width: 128px"><asp:TextBox ID="txt4" placeholder="Enter Message" runat="server" BackColor="#FF9999"></asp:TextBox></td>
           </tr>

            <tr>
                <td colspan="2" align="center" style="border-style: solid; border-width: medium; background-color: white;"> <asp:Button ID="Button1" runat="server" Text="Submit" BackColor="white" Height="42px" Width="100px" OnClick="Button1_Click"></asp:Button></td>
            </tr>
